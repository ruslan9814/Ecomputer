    ...
    public partial class INTIALIZE_DB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApplicableProductsId = table.Column<int>(type: "integer", nullable: false),
                    CouponsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPromoCode", x => new { x.ApplicableProductsId, x.CouponsId });
                    table.ForeignKey(
                        name: "FK_ProductPromoCode_Products_ApplicableProductsId",
                        column: x => x.ApplicableProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPromoCode_PromoCodes_CouponsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPromoCode_CouponsId",
