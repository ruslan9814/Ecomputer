...
public sealed class GetFilterProductQueryHandler(IProductRepository productRepository) : IRequestHandler<GetFilterProductQuery, Result<GetFilterProductPageDto>>
{
    private readonly IProductRepository _productRepository = productRepository;

    public async Task<Result<GetFilterProductPageDto>> Handle(GetFilterProductQuery request, CancellationToken cancellationToken)
    {
